...
import ru.radviger.damageindicators.util.EntityConfigurationEntryComparator;
...
public class AdvancedGui extends GuiScreen {
    ...
    public void onGuiClosed() {
        super.onGuiClosed();
        IndicatorsConfig.mainInstance().popOffsEnabled = this.popoffsetting;
        IndicatorsConfig.mainInstance().portraitEnabled = this.portraitsetting;
    }
