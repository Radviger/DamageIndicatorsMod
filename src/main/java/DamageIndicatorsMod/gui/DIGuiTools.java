...
public class DIGuiTools extends GuiIngame {
    ...
    public static void drawPotionBoxes(EntityLivingBase el) {
        ...
        try {
            ...
            if (diConfig.enablePotionEffects && DIEventBus.potionEffects.get(el.getEntityId()) != null && !DIEventBus.potionEffects.get(el.getEntityId()).isEmpty()) {
                int position = 0;
                if (DIEventBus.potionEffects.containsKey(el.getEntityId())) {
                    for (PotionEffect adjy : DIEventBus.potionEffects.get(el.getEntityId())) {
                        ...
                        if (duration > 0) {
                            ...
                            if (potion.hasStatusIcon() && duration > 10) {
                                ...
                                if (!ex) {
                                    ex = true;
                                    adjx1 = diConfig.locX + PotionBoxOffsetX;
                                    adjy1 = diConfig.locY + PotionBoxOffsetY;
                                ...
                                adjx1 = diConfig.locX + PotionBoxOffsetX + position * 20 + potionBoxSidesWidth;
                                adjy1 = diConfig.locY + PotionBoxOffsetY;
                    ...
                    if (ex) {
                        ...
                        int duration = diConfig.locY + PotionBoxOffsetY;
